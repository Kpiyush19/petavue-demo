...
/* Agents — the shared agent glyph (Phosphor Cpu). One mark for the whole
   surface; individual agent families carry their own icons on their cards.
   Regular when at rest, filled when active — matching the other nav items.
   Both paths are Phosphor's own, taken from @phosphor-icons/react. */

/**
 * The agent glyph — one mark shared by every agent family.
 *
 * Families are told apart by name only for now; per-agent colour and iconography
 * come later, so this stays monochrome and inherits `currentColor`.
 */
export function AgentGlyph({ size = 20, className = "" }) {
  return (
    <svg
